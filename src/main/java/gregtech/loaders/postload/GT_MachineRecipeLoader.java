...
//        tNBT.setInteger("Capacity",144);
//        flask.readFromNBT(tNBT);
//        GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("gregtech","gt.Volumetric_Flask",1),GT_Utility.getIntegratedCircuit(1),flask,10,30);
